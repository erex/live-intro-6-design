...
date: Exercise 6. Distance sampling survey design <br> September 2020
output: 
...
```{r designspacingsol2, eval=TRUE, include=FALSE}
...
```{r zzcoveragesol, eval = TRUE, include=FALSE, fig.cap="Coverage grid plot for zigzag design.", fig.width=4, fig.height=4.5}
...
```{r fig1, echo=FALSE, fig.cap="The coverage scores for each strata separately for the point transect Tentsmuir Forest survey design.", fig.height = 2, fig.align='center'}
